...
import QuanLyBanThuoc.BUS.PhanQuyenBUS;
import QuanLyBanThuoc.BUS.TaiKhoanBUS;
import QuanLyBanThuoc.DAO.MyConnect;
import QuanLyBanThuoc.DTO.NhanVien;
import QuanLyBanThuoc.DTO.PhanQuyen;
import QuanLyBanThuoc.DTO.TaiKhoan;
...
public class QL_NhanVien extends JFrame {
	...
	public QL_NhanVien() {
		...
		cbx_chucvu.setModel(new DefaultComboBoxModel(new String[] { "Nhân viên","Admin" }));
		...
		btn_Sua.addActionListener(new ActionListener() {
            ...
            // Nếu có dòng được chọn, tiến hành sửa thông tin nhân viên
            suaTaiKhoan();
        }
    
			}
		});
		btn_Sua.setBounds(136, 129, 85, 21);
		panel_3.add(btn_Sua);
		...
		btn_khoa.setBounds(248, 129, 85, 21);
		...
		btn_them.setBounds(25, 129, 85, 21);
		...
		btn_mokhoa.setBounds(365, 129, 85, 21);
...
//		panel_4.add(btnNewButton_6);
        ...
        if (txt_timKiem.getText().isEmpty()) {
            ...
            return; // Kết thúc việc xử lý tìm kiếm
        }
