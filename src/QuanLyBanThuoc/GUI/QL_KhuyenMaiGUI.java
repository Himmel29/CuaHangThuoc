...
import QuanLyBanThuoc.BUS.KhuyenMaiBUS;
import QuanLyBanThuoc.DAO.MyConnect;
import QuanLyBanThuoc.DTO.CTKhuyenMai;
import QuanLyBanThuoc.DTO.KhuyenMai;
...
//	}
	...
	/*private void themKhuyenMai() {
        ...
        private void themKhuyenMai() {
    try {
        int maKM = Integer.parseInt(txt_MaKM.getText());
        
        boolean flag = KMBUS.themKhuyenMai(maKM, txt_TenKM.getText(), date_BĐ.getDate(), date_KT.getDate());
        ...
        JOptionPane.showMessageDialog(null, "Vui lòng nhập mã khuyến mãi là một số nguyên hợp lệ!");
	...
	private void xoaCTKM() {
            String maKMCT = txt_MaKMCT.getText();
    String maSP = txt_maSP.getText();

    if (maKMCT.isEmpty() || maSP.isEmpty()) {
        JOptionPane.showMessageDialog(null, "Vui lòng điền thông tin đầy đủ để xóa!");
        return; // Kết thúc ngay nếu có trường trống
    }
