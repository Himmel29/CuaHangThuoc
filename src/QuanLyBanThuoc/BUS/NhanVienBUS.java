...
import QuanLyBanThuoc.DAO.NhanVienDAO;
...
public class NhanVienBUS {
    ...
    if (ma.equals("") || ten.equals("") || chucVu.equals("") || ho.equals("")) {
        new MyDialog("Vui lòng điền đủ thông tin!", MyDialog.ERROR_DIALOG);
        return false;
    }
    ...
    try {
        ...
        new MyDialog("Mã nhân viên phải là số!", MyDialog.ERROR_DIALOG);
        return false;
    }
    ...
    public boolean updateNhanVien(String ma, String ho, String ten, String gioiTinh, String chucVu) {
    	if(ma.equals("")||ten.equals("")||chucVu.equals("")||ho.equals("")){
            new MyDialog("Hãy điền đủ thông tin!", MyDialog.ERROR_DIALOG);
            return false;
        }
