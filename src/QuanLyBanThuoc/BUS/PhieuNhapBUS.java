...
import QuanLyBanThuoc.DAO.PhieuNhapDAO;
...
public class PhieuNhapBUS {
    ...
    public boolean themPhieuNhap(String nhaCungCap, String nhanVien, int tongTien, int maPN) {
    int maNCC = Integer.parseInt(nhaCungCap);
    int maNV = Integer.parseInt(nhanVien);
    PhieuNhap pn = new PhieuNhap();
    pn.setMaPN(maPN); // Đặt giá trị cho maPN
    pn.setMaNCC(maNCC);
    pn.setMaNV(maNV);
    pn.setTongTien(tongTien);
